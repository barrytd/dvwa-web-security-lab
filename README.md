...
| [HackPark](labs/2026-03-07-hackpark-blogengine-rce-scheduledtask-privesc/README.md) | TryHackMe | Hydra brute force, BlogEngine.NET RCE (CVE-2019-6714), scheduled-task SYSTEM privesc — done twice, Metasploit and manual. |
...
| [VulnNet: Active](labs/2026-02-27-vulnnet-active-windows-privesc/README.md) | TryHackMe | Unauth Redis → Responder NTLM capture → cracked → SMB share abuse → GodPotato to SYSTEM. |
| [Attacktive Directory](labs/2026-02-26-tryhackme-attacktive-directory/README.md) | TryHackMe | Full AD methodology — Kerberoasting, ASREPRoasting, BloodHound attack-path mapping. |
...
| [Kioptrix Level 2](labs/2026-02-22-kioptrix-level-1.1-web-to-root/README.md) | VulnHub | SQLi auth bypass → command injection → hardcoded creds → kernel privesc via `sock_sendpage()`. |
