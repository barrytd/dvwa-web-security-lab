...
10.10.12.13/29 expands to 8 IP addresses starting at 10.10.12.8, confirming the /29 subnet layout (32 - 29 = 3 host bits = 8 addresses). The -n flag was used to skip reverse DNS resolution so the output stayed clean. For the range 10.10.0-255.101-125, Nmap would enumerate 256 x 25 = **6,400** IP addresses.
