...
- Default Nessus discovery does not cover all 65535 ports. The all-ports option under Discovery is mandatory any time the target's services might not be on common ports, the same lesson as the Net Sec Challenge room where port 10021 hid an FTP server
