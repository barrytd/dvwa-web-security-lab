...
`/development/` was an unauthenticated file upload endpoint that allowed PHP to be written directly into a web-executable directory — the original root-cause flaw the CooctusClan abused.
